...
# -*- coding: utf-8 -*-
"""
Name: Real-CUGAN NCNN Vulkan Driver
Creator: K4YT3X
Date Created: May 26, 2020
Last Modified: September 21, 2020

Description: This class is a high-level wrapper
for realcugan_ncnn_vulkan.
"""
...
class WrapperMain:
    """This class communicates with RIFE NCNN Vulkan engine
    ...
    def parse_arguments(arguments):
        ...
        parser.add_argument("-n", type=int, choices=range(-1, 3), help="denoise level")
        parser.add_argument("-s", type=int, help="upscale ratio")
        parser.add_argument("-t", type=int, help="tile size (>=32/0=auto)")
        parser.add_argument("-m", type=str, help="realcugan model path")
